...
public class StockList extends javax.swing.JPanel {
    ...
    private void loadStock() {
        ...
        try {
            String query = "SELECT * FROM `main_stock` "
                    + "INNER JOIN `medicine`"
                    + "ON `main_stock`.`medicine_id` = `medicine`.`id`"
                    + "INNER JOIN `brand`"
            ...
            while (resultSet.next()) {
                ...
                vector.add(resultSet.getString("main_stock.qty"));
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(jScrollPane4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1150, Short.MAX_VALUE)
        );

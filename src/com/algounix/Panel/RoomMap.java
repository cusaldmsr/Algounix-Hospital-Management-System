...
//                    try (InputStream path = this.getClass().getResourceAsStream("/com/algounix/Reports/Algounix-HMS-RoomMap-Report1.jrxml")) {
//
//                        if (path == null) {
...
//                        params.put("Parameter16", patientGender);
//
//                        JasperPrint jasperPrint = JasperFillManager.fillReport(path, params);
//                        JasperViewer.viewReport(jasperPrint, false);
//
//                        System.out.println("Employee Id: " + SignIn.empID + " printed Room Detail report of: Room No. " + roomNo + " at: " + date);
//

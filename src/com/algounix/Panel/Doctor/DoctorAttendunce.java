...
public class DoctorAttendunce extends javax.swing.JPanel {
        ...
        try {
            ...
            while (resultSet1.next()) {
                ...
                for (LocalDate date : dates) {
                    ResultSet resultSet3 = MySQL
                            .executeSearch("SELECT * FROM `doctor_availability` WHERE `date`='" + date + "' AND "
                                    + "`doctor_id`='" + doctorID + "'");

                    if (!resultSet3.next()) {
                        MySQL.executeIUD(
                                "INSERT INTO `doctor_availability` (`date`,`doctor_id`,`availability_status_id`) "
        ...
        jPanel1Layout.setHorizontalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 285,
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel5Layout
                                        ...
                                        .addComponent(jCheckBox6, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(jCheckBox7, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel6Layout.createSequentialGroup()
                                .addGroup(jPanel6Layout
                                        ...
                                        .addComponent(jCheckBox11, javax.swing.GroupLayout.Alignment.LEADING,
                                                ...
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(jCheckBox10, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                ...
                                .addGroup(jPanel6Layout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(jCheckBox12, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(jCheckBox13, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(jCheckBox14, javax.swing.GroupLayout.DEFAULT_SIZE, 183,
                                                Short.MAX_VALUE))));
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addGroup(jPanel4Layout.createSequentialGroup()
                                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addComponent(jButton5, javax.swing.GroupLayout.PREFERRED_SIZE, 243,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(jPanel4Layout.createSequentialGroup()
                                                .addGap(13, 13, 13)
    ...
    private void jTextField2KeyReleased(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_jTextField2KeyReleased
        ...
        if (!text.isEmpty()) {
            try {
                ...
                ResultSet resultSet = MySQL.executeSearch("SELECT * FROM `doctor` WHERE `first_name` LIKE '%" + text
    ...
    private void jList2MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jList2MouseClicked
        ...
        try {
            ResultSet resultSet = MySQL.executeSearch(
                    "SELECT * FROM `doctor` WHERE `first_name`='" + name[0] + "' AND `last_name`='" + name[1] + "'");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (doctorID.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Please Select Available Week Days.", "Warning",
                    JOptionPane.WARNING_MESSAGE);
        } else if (timeSlotsList.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please Select Available Time Slots.", "Warning",
                    JOptionPane.WARNING_MESSAGE);
        } else {
            try {

                ResultSet resultSet = MySQL
                        .executeSearch("SELECT * FROM `doctor_has_week_days` WHERE `doctor_id`='" + doctorID + "'");
                ...
                if (!resultSet.next()) {
                    ...
                    JOptionPane.showMessageDialog(this, "Attendance Already Added.", "Warning",
                            JOptionPane.WARNING_MESSAGE);
                }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            try {
                ...
                ResultSet resultSet2 = MySQL
                        .executeSearch("SELECT * FROM `doctor_has_time_slots` WHERE `doctor_id`='" + doctorID + "'");
        ...
        if (doctorID.isEmpty()) {
            ...
            if (selectedRow != -1) {
                ...
                try {
                    ...
                    int ans = JOptionPane.showConfirmDialog(this, "Are you sure you need two update status",
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        try (InputStream path = this.getClass()
                .getResourceAsStream("/com/algounix/Reports/Doctor_Attendance_List_HMS2.jasper")) {

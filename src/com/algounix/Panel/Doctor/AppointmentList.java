...
public class AppointmentList extends javax.swing.JPanel {
     ...
     private void loadAppointment() {
        try {
            ...
            if (appoId.isEmpty()) {
                ...
                query += " WHERE `appoinment` . `id` LIKE '" + appoId + "' ";
            }
            if (patientName.isEmpty()) {
                query += "";
            } else {
                query += " WHERE `patient` . `first_name` LIKE '" + patientName + "' ";
            }
  ...
  try (InputStream path = this.getClass().getResourceAsStream("/com/algounix/Reports/Algounix-HMS-Appointmentlistn.jasper")) {

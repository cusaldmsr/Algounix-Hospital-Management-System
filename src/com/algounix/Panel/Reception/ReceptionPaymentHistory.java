 ...
 * @author kusal
 */
public class ReceptionPaymentHistory extends javax.swing.JPanel {

    private static HashMap<String, String> PaymentMethodMap = new HashMap<>();

    public ReceptionPaymentHistory() {
        initComponents();
...
//            }
    ...
    private void displayChart() {
        chartpanel.add(createPieChartPanel(createPaymentDistributionDataset(), "Payment Method Distribution"));
    ...
    //piechart 1 Dataset
    private DefaultPieDataset createPaymentDistributionDataset() {
        DefaultPieDataset dataset = new DefaultPieDataset();
        try {
            ResultSet rs = MySQL.executeSearch("SELECT pm.name AS payment_method, COUNT(*) AS total\n"
                    + "FROM hospital_invoice hi\n"
                    + "JOIN payment_method pm ON hi.payment_method_id = pm.id\n"
                    + "GROUP BY pm.name");

            while (rs.next()) {
                String company = rs.getString("payment_method");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reception Payment History ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try (InputStream path = this.getClass().getResourceAsStream("/com/algounix/Reports/Reception_Invoice_Report_HMS3.jasper")) {
